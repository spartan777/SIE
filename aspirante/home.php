<?php
  ...
  switch ($op) {
    case 'generales':
	  $contenido = "php/datos_generales.php";
    $tittle = "Datos Generales";
	  break;

	case 'domicilio':
	  $contenido = "php/domicilio_actual.php";
    $tittle = "Datos del Domicilio";
	  break;

	case 'socioeconomicos':
	  $contenido = "php/datos_socioecomicos.php";
