...
$sql = "SELECT gen.paterno, gen.materno, gen.nombre, gen.fecha_nacimiento, dom.estado_civil,
               ...
               gen.escuela_procedencia, gen.promedio, gen.secundaria_estudio, gen.promedio_secundaria, gen.id_carrera_1
...
<div class="main">
  ...
  <div>
    ...
    <label>Carrera a Cursar:</label><br>
		<select class="select" name="id_carrera" >
    ...
    <input type="hidden" id="domicilio_distinto" name="domicilio_distinto" value="<?php echo $res["domicilio_distinto"]; ?>">
	    <br>
	    <input class="submit-asp" id="submit-form" type="submit" value="Guardar Datos">
	</form>
<?php } ?>
