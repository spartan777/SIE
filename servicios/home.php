<?php
  ...
  switch ($op) {
    case 'inscripcion':
	  $contenido = "php/buscar_alumno.php";
    $tittle = "Búsqueda de Alumnos";
	  break;

	case 'datos_inscripcion':
	  $contenido = "php/datos_inscripcion.php";
    $tittle = "Datos del Alumno";
	  break;

	case 'reinscripcion':
	  $contenido = "php/reinscripcion.php";
    $tittle = "Datos Socioeconomicos";
      break;

  case 'contacto':
    $contenido = "php/datos_contacto.php";
...
<html>
<head>
		<title>SIE|<?php echo $tittle; ?></title>
	<meta charset="utf-8">
	...
	<script src="../docente/javascript/desp-salir.js"></script>
</head>
<body>
	<header>
		<img class="img-logo" src="../logo-sie-brain.svg">
		<!--<img class="img-user" src="../../img/logo-user.svg">-->
	</header>
	<nav>
		<ul>
			<li class="dropdown">
				<a href="?op=inscripcion" class="dropbtn">Inscripción</a>
			</li>
      <li class="dropdown">
				<a href="?op=inscripcion" class="dropbtn">Re-Inscripción</a>
			</li>
		</ul>
	</nav>
