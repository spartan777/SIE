<?php
  ...
  switch ($op) {
    case 'calificaciones':
	  $contenido = "php/calificaciones.php";
	  break;
	...
	case 'documentacion':
	  $contenido = "php/consulta-documentacion.php";
      break;
	
	case 'progreso':
	  $contenido = "php/consulta-progreso.php";
	  break;
		...
		<ul>
			<li class="dropdown">
				...
				<div class="dropdown-content">
					<?php include("php/periodos-calificaciones.php");?>
				...
				<li class="dropdown">
					<a href="javascript:void(0)" class="dropbtn">Documentación</a>
					<div class="dropdown-content">
						<a href="?op=documentacion&val=constancias">Constancias</a>
						<a href="?op=documentacion&val=cedulas">Cédulas</a>
						<a href="?op=documentacion&val=cartas">Cartas</a>
						<a href="?op=documentacion&val=kardex">Historial</a>
						<a href="?op=documentacion&val=boletas">Boletas</a>
						<a href="?op=documentacion&val=credencial">Credencial</a>
						<a href="?op=documentacion&val=titulacion">Titulación</a>
					</div>
				</li>
				<li>
					<a href="?op=progreso">Progreso</a>
				</li>
		</ul>
	</nav>
