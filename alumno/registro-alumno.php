...
<head>
	...
	<script type="text/javascript">var con = "<?php echo $context; ?>"; var nom = "<?php echo $nombre?>";</script>
	<style type="text/css">
...
<body>
	...
	<div class="main-cont">
		<p class="txt-main">Ingresa tu número de control!</p>
		<hr>
		...
		<a href="../index.php?nivel=alumno">Pagina Ingreso?</a>
		<div>
